...
public class BlueTeleopBetter extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        out: while(opModeIsActive()){
            ...
            Trajright = Drive.trajectoryBuilder(new Pose2d(xCoord, yCoord, rot)).lineToLinearHeading(new Pose2d(51 + xTrim, 30 + yTrim, 0)).build();
            Trajleft = Drive.trajectoryBuilder(new Pose2d(xCoord, yCoord, rot)).lineToLinearHeading(new Pose2d(51 + xTrim, 42 + yTrim, 0)).build();
