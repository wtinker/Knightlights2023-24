...
public class BlueTeleop extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()){
            ...
            Trajright = Drive.trajectoryBuilder(new Pose2d(xCoord, yCoord, rot)).lineToLinearHeading(new Pose2d(51 + xTrim, 28 + yTrim, 0)).build();
            Trajleft = Drive.trajectoryBuilder(new Pose2d(xCoord, yCoord, rot)).lineToLinearHeading(new Pose2d(51 + xTrim, 40 + yTrim, 0)).build();
