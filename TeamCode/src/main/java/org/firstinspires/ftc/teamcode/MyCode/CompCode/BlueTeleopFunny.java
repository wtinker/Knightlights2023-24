...
@TeleOp(name = "Blue Teleop funny")
public class BlueTeleopFunny extends LinearOpMode {
        ...
        while(opModeIsActive()&&running){
            ...
            switch (robotstate){
                ...
                case OUTPUT:
                    ...
                    if(gamepad1.right_bumper && rightCooldown()){
                        output.Cycle();
                    }
                    if(gamepad1.dpad_left){Drive.followTrajectoryAsync(Trajleft);}
                    if(gamepad1.dpad_right){Drive.followTrajectoryAsync(Trajright);}
                    runMod();
                    intake.Raise();
                    intake.Stop();
    ...
    public void runMod(){
        if(gamepad1.dpad_up){mod += 50;}
        if(gamepad1.dpad_down){mod -= 50;}
